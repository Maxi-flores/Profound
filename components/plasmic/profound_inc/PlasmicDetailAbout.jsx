...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: FaA3IDHDcZY1/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__oMZj)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__gd1A)}>
            <h5
